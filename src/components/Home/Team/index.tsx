        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {teamMembers.map((member, index) => (
            <div
              ...
              <div className='w-24 h-24 rounded-2xl overflow-hidden mb-6 ring-2 ring-slate-200 dark:ring-slate-700 group-hover:ring-emerald-500/50 transition-all flex items-center justify-center bg-gradient-to-br from-cyan-500/20 via-blue-600/20 to-purple-600/20'>
                {member.image ? (
                  <Image
                    src={member.image}
                    alt={member.name}
