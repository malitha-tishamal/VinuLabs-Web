      ...
      <section className='dark:bg-darkmode pt-8 md:pb-24 pb-16'>
        <div className='container mx-auto max-w-6xl px-4'>
              ...
              <div className='flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between'>
                <div>
                  ...
                  <p className='text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50'>
                    Have a project idea? Need a partner for AI, IoT, or enterprise systems? We're ready to help transform your vision into reality.
                  </p>
                </div>
                <div>
                  <Link
            ...
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4'>
              ...
              <div className='flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between'>
                <div>
                  ...
                  <p className='text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50'>
                    Join our internship programs, AI bootcamps, and real-world project experiences. Grow your skills with industry experts.
                  </p>
                </div>
                <div>
                  <Link
          ...
          <div className='md:pt-32 pt-11 md:pb-28 pb-8'>
            <div className='bg-section dark:bg-darklight p-8 rounded-lg mb-6'>
              <h3 className='text-2xl font-bold text-midnight_text dark:text-white mb-4'>
                📍 Head Office
              </h3>
              <p className='text-grey dark:text-white/70 text-lg mb-2'>
                Galle, Sri Lanka
              </p>
            ...
            <iframe
              src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126748.60912427777!2d80.203895!3d6.0329!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae173a378ee799d%3A0x57b0b5c5c5c5c5c5!2sGalle%2C%20Sri%20Lanka!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus'
              width='1114'
              height='477'
              loading='lazy'
