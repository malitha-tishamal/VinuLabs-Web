...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07090e] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Ambient glows */}
      <div className="absolute top-[-100px] left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-cyan-500/8 blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-60px] right-[-60px] w-80 h-80 rounded-full bg-violet-600/8 blur-[100px] pointer-events-none" />
          ...
          {step === 'form' ? (
            <>
              ...
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/20 flex items-center justify-center mx-auto mb-4">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-7 h-7 text-cyan-400">
            ...
            <>
              {/* Check icon */}
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-teal-600/20 border border-emerald-500/30 flex items-center justify-center mx-auto mb-4 animate-[bounce_1s_ease-in-out_1]">
          ...
          {step === 'form' ? (
            <>
              ...
              <form onSubmit={handleReset} className="space-y-5" noValidate>
                <div>
                  <label htmlFor="reset-email" className="block text-xs font-semibold text-slate-400 mb-1.5">
                    Email address
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 rounded-xl bg-slate-800/60 border text-white text-sm placeholder-slate-500
                        ...
                        ${email.length > 0 && !isEmailValid ? 'border-rose-500/50' : 'border-slate-700'}`}
                    />
                    {isEmailValid && (
